...
package com.hustunique.parser.extractor;
...
import com.hustunique.parser.Base64;
import com.hustunique.parser.ExtractException;
import com.hustunique.parser.entity.Seg;
import com.hustunique.parser.entity.Stream;
import com.hustunique.parser.entity.VideoInfoImpl;
import com.hustunique.parser.util.LogUtil;
import com.hustunique.parser.util.Util;
...
public class YoukuExtractor extends Extractor {
    ...
    VideoInfoImpl createInfo(@NonNull Response response) throws IOException {
        ...
        mOip = getOip(data);
        LogUtil.d(TAG, "sid: " + mSid + " ,mToken: " + mToken + " ,oip: " + mOip);
        mFiledMap = constructFiledMap(data);
        String title = getTitle(data);
        Map<Integer, Stream> streamMap = getSegMap(data);
        Logger.getLogger(TAG).log(Level.CONFIG, "hd length:" + streamMap.keySet().size());
